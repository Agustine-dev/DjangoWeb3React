...
export default function Register() {
    ...
    async function onSubmitForm(event) {
        ...
        const data = {
            ...
            ethAddress: ethAddress.current.value
          };
    ...
    return (
        <div className='container'>
            ...
            <form onSubmit={onSubmitForm}>
                ...
                <div className="mb-3">
                    <input type="text" ref={ethAddress} id="ethAddress" autoComplete='off' className='form-control' placeholder='Enter Ethereum Address' />
                </div>
                <div className="mb-3">
